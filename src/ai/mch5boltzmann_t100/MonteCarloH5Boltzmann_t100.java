 ...
 *
 */
public class MonteCarloH5Boltzmann_t100 implements Engine {
	 ...
	 * @param root 
	 */
	public MonteCarloH5Boltzmann_t100(Board board, String color, int moveNumber, 
			int allMovesNumber) {
		this.board = board;
		this.color = color;
...
private void childrenProbabilityT100(Node child, double sum, double t) {
	...
	private Node pickedNumberT100 (List<Tuple<Double, Node>> organizedChildren, 
