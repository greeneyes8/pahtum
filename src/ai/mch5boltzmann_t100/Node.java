...
public class Node {
	...
	public Node(Node parent, Tuple<Integer, Integer> move, String color, 
		...
		int valuenode_t100 = 5;
		this.untriedMoves = board.heuristic_bestX_moves(color, valuenode_t100);
	 ...
	 */
	public Node expand(Board board_ex){
		String newColor;
	 ...
	 */
	public void updateValue(double value_up) {
		this.value += value_up;
	}
