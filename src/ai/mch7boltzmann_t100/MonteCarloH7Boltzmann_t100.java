 ...
 *
 */
public class MonteCarloH7Boltzmann_t100 implements Engine {
	 ...
	 * @param root 
	 */
	public MonteCarloH7Boltzmann_t100(Board board, String color, int moveNumber, 
			int allMovesNumber) {
		this.board = board;
		this.color = color;
	 ...
	 */
	private String defaultPolicy(Node sdp_node, Board sdp_board) throws Exception {
		Random generator = new Random();
		String color = sdp_node.getColor();
		...
		//game (who win: "w"/"b"/"0").
		return Rules.calculateScore(sdp_board);
	}
	...
	private Node bestChild(Node node) {
		...
		//picked number.
		selectedChild = pickedNumber_T100 (organizedChildren, 
...
private void childrenProbabilityT100(Node child, double sum, double t) {
	...
	private Node pickedNumber_T100 (List<Tuple<Double, Node>> organizedChildren, 
