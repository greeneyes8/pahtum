...
//					move = charles.getMove();
			...
			if(gameOutcome.equals(zero)) {
				...
				//Update statistics.
				if(playersTest5[0].getName().equals("MCTS_H(7)")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest5[0].getColor())) {
					...
					//Update statistics.
					if(playersTest5[1].getName().equals("MCTS_H(7)")) {
						e1TotalWins++;
						e2TotalLoses++;
...
//					move = charles.getMove();
			...
			if(gameOutcome.equals(zero)) {
				...
				//Update statistics.
				if(playersTest6[0].getName().equals("MCTS_H(10)")) {
					e1DrawAsPlayer1++;
					e2DrawAsPlayer2++;
				} else {
					e1DrawAsPlayer2++;
				...
				if(gameOutcome.equals(playersTest6[0].getColor())) {
					...
					//Update statistics.
					if(playersTest6[1].getName().equals("MCTS_H(10)")) {
						e1TotalWins++;
						e2TotalLoses++;
