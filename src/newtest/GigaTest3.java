...
public static void newRandomBoardOne3 (int testIndex, Board boardTest1, 
...
public static void testOne3() throws Exception {
	...
	BufferedWriter outputTest1 = new BufferedWriter(
			new FileWriter("results_20k_11b_MCTS_UCTvMCTS_H(5).txt", true));
	...
	for(int testIndex = 1; testIndex <= 100; ++testIndex) {
		...
		//new random board.
		newRandomBoardOne3 ( testIndex,  boardTest1, 
		...
		if(gameOutcome.equals(zero)) {
			...
			if(gameOutcome.equals(playersTest1[0].getColor())) {
				...
				//Update statistics.
				boolean valuePlayer1 = playersTest1[0].getName().equals("MCTS_H(5)");
				updateStatisticsB3 ( valuePlayer1,  e1TotalWins,
				...
				//Update statistics.
				boolean valuePlayer1 = playersTest1[1].getName().equals("MCTS_H(5)");
				updateStatisticsB3 ( valuePlayer1,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			}
...
public static void newRandomBoardTwo3 (int testIndex, Board boardTest2, 
...
public static void testTwo3 () throws Exception {
	...
	BufferedWriter outputTest2 = new BufferedWriter(
			new FileWriter("results_20k_11b_MCTS_UCTvMCTS_H(7).txt", true));
	...
	for(int testIndex = 1; testIndex <= 100; ++testIndex) {
		...
		//Reset the board to an initial state. When index is odd generate a 
		//new random board.
		newRandomBoardTwo3 ( testIndex,  boardTest2, 
		...
		if(gameOutcome.equals(zero)) {
			...
			if(gameOutcome.equals(playersTest2[0].getColor())) {
				...
				//Update statistics.
				boolean valuePlayer2 = playersTest2[0].getName().equals("MCTS_H(7)");
				updateStatisticsB3 ( valuePlayer2,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
				...
				//Update statistics.
				boolean valuePlayer2 = playersTest2[1].getName().equals("MCTS_H(7)");
				updateStatisticsB3 ( valuePlayer2,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			}
...
public static void newRandomBoardThree3 (int testIndex, Board boardTest3, 
...
public static void testThree3 () throws Exception {
	...
	//Players participating in the test case.
	Player[] playersTest3 =  {
			new Player("MCTS_UCT", "MCTS_UCT", "w", 20000),
	...
	BufferedWriter outputTest3 = new BufferedWriter(
			new FileWriter("results_20k_11b_MCTS_UCTvMCTS_H(10).txt", true));
	...
	for(int testIndex = 1; testIndex <= 100; ++testIndex) {
		...
		//Reset the board to an initial state. When index is odd generate a 
		//new random board.
		newRandomBoardThree3 ( testIndex,  boardTest3, 
		...
		if(gameOutcome.equals(zero)) {
			...
			if(gameOutcome.equals(playersTest3[0].getColor())) {
				...
				updateStatisticsB3 ( valuePlayer3,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
				...
				//Update statistics.
				boolean valuePlayer3 = playersTest3[1].getName().equals("MCTS_H(10)");
				updateStatisticsB3 ( valuePlayer3,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			}
...
public static void newRandomBoardFour3 (int testIndex, Board boardTest4, 
...
public static void testFour3() throws Exception {
	...
	BufferedWriter outputTest4 = new BufferedWriter(
			new FileWriter("results_20k_11b_MCTS_UCTvMCTS_H(5+5).txt", true));
	...
	for(int testIndex = 1; testIndex <= 100; ++testIndex) {
		...
		//Reset the board to an initial state. When index is odd generate a 
		//new random board.
		newRandomBoardFour3 ( testIndex,  boardTest4, 
		...
		if(gameOutcome.equals(zero)) {
			...
			if(gameOutcome.equals(playersTest4[0].getColor())) {
				...
				updateStatisticsB3 ( valuePlayer4,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			} else {
				//Player #2, whoever it is, wins the game.
				...
				//Update statistics.
				boolean valuePlayer4 = playersTest4[1].getName().equals("MCTS_H(5+5)");
				updateStatisticsB3 ( valuePlayer4,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			}
...
public static void newRandomBoardFive3 (int testIndex, Board boardTest5, 
...
public static void testFive3 () throws Exception {
	...
	BufferedWriter outputTest5 = new BufferedWriter(
			new FileWriter("results_20k_11b_MCTS_H(5)vMCTS_H(7).txt", true));
	...
	for(int testIndex = 1; testIndex <= 100; ++testIndex) {
		...
		//Reset the board to an initial state. When index is odd generate a 
		//new random board.
		newRandomBoardFive3 ( testIndex,  boardTest5, 
...
//				move = charles.getMove();
		...
		if(gameOutcome.equals(zero)) {
			...
			if(gameOutcome.equals(playersTest5[0].getColor())) {
				...
				//Update statistics.
				boolean valuePlayer5 = playersTest5[0].getName().equals("MCTS_H(7)");
				updateStatisticsB3 ( valuePlayer5,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			} else {
				//Player #2, whoever it is, wins the game.
				...
				//Update statistics.
				boolean valuePlayer5 = playersTest5[1].getName().equals("MCTS_H(7)");
				updateStatisticsB3 ( valuePlayer5,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			}
...
public static void newRandomBoardSix3 (int testIndex, Board boardTest6, 
...
public static void testSix3() throws Exception {
	...
	BufferedWriter outputTest6 = new BufferedWriter(
			new FileWriter("results_20k_11b_MCTS_H(7)vMCTS_H(10).txt", true));
	...
	for(int testIndex = 1; testIndex <= 100; ++testIndex) {
		...
		//Reset the board to an initial state. When index is odd generate a 
		//new random board.
		newRandomBoardSix3 ( testIndex,  boardTest6, 
...
//				move = charles.getMove();
		...
		if(gameOutcome.equals(zero)) {
			...
			if(gameOutcome.equals(playersTest6[0].getColor())) {
				...
				//Update statistics.
				boolean valuePlayer6 = playersTest6[0].getName().equals("MCTS_H(10)");
				updateStatisticsB3 ( valuePlayer6,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
				...
				//Update statistics.
				boolean valuePlayer6 = playersTest6[1].getName().equals("MCTS_H(10)");
				updateStatisticsB3 ( valuePlayer6,  e1TotalWins,
						 e2TotalLoses, e1WinAsPlayer2,  e2LoseAsPlayer1,
						 e2TotalWins,  e1TotalLoses,  e2WinAsPlayer2,  e1LoseAsPlayer1);
			}
